      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-muted-foreground hover:text-[#af0e0e] text-sm transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-muted-foreground hover:text-[#af0e0e] text-sm transition-colors">
                  Contact Us
                </Link>
              </li>
              {/*<li>
              ...
              <li>
                <Link href="/blog" className="text-muted-foreground hover:text-[#af0e0e] text-sm transition-colors">
                  Blog
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin size={18} className="mr-2 text-[#af0e0e] mt-0.5" />
