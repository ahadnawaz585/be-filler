            ...
            {isLoggedIn ? (
              ...
              <>
                ...
                <Link href="/auth/signup">
                  <Button variant="default" className="bg-[#af0e0e] hover:bg-[#8a0b0b]">Sign Up</Button>
                </Link>
              </>
            )}
          </div>
              ...
              {isLoggedIn ? (
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <Link href="/auth/signup" className="w-full" onClick={toggleMenu}>
                    <Button variant="default" className="w-full bg-[#af0e0e] hover:bg-[#8a0b0b]">Sign Up</Button>
                  </Link>
                </div>
              )}
            </div>
