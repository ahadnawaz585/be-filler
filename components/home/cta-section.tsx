        ...
        <div className="max-w-4xl mx-auto bg-card rounded-xl p-8 md:p-12 shadow-lg border">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              ...
              >
                ...
                <ul className="space-y-2 mb-8">
                  {benefits.map((benefit, index) => (
                    ...
                    >
                      <CheckCircle className="w-5 h-5 text-[#af0e0e] mr-2 mt-0.5 flex-shrink-0" />
                      <span>{benefit}</span>
                    </motion.li>
                  ))}
                </ul>
            ...
            <div className="flex-1 lg:flex-none lg:w-1/3 hidden lg:block">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#af0e0e]/20 to-[#af0e0e]/5 rounded-lg" />
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full px-6">
                  <div className="w-20 h-20 bg-[#af0e0e]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    <CheckCircle className="w-10 h-10 text-[#af0e0e]" />
                  </div>
