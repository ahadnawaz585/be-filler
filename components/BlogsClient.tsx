...
export function BlogsClient({ blogs, error }: { blogs: Content[]; error: string | null }) {
    ...
    const placeholderBlogs: Blog[] = [
        {
            id: 'b1',
            title: 'How to File Taxes in Pakistan with BeFiler',
            excerpt: 'A beginner’s guide to filing income tax returns using BeFiler’s platform.',
        ...
        },
        {
            ...
            excerpt: 'Learn the steps to register for an NTN with BeFiler in minutes.',
                        ...
                        {blogsToDisplay.map((blog, index) => (
                            ...
                            >
                                ...
                                <div className="p-4">
                                    ...
                                    <p className="text-xs text-gray-600 font-poppins line-clamp-2 mt-1">{blog.excerpt}</p>
