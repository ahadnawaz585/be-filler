  ...
  return (
    <main className="container mx-auto px-4 py-16 mt-16">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
        <div className="lg:w-1/2">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Complete your income tax return filing with Befiler. Our comprehensive service includes both the Income Tax
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            ...
            <Card className="h-full hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="w-12 h-12 bg-[#af0e0e]/10 rounded-lg flex items-center justify-center mb-4">
                  <FileText className="w-6 h-6 text-[#af0e0e]" />
                </div>
              ...
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-[#af0e0e] font-bold">•</span>
              ...
              <CardFooter>
                <Link href="/services/income-tax-returns/tax-filing" className="w-full">
                  <Button variant="outline" className="w-full text-[#af0e0e] hover:text-[#af0e0e] hover:bg-[#af0e0e]/5">
          ...
          >
            <Card className="h-full hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="w-12 h-12 bg-[#af0e0e]/10 rounded-lg flex items-center justify-center mb-4">
                  <BarChart4 className="w-6 h-6 text-[#af0e0e]" />
                </div>
      ...
      <div className="mb-16 bg-card p-8 rounded-lg">
        <h2 className="text-3xl font-bold text-center mb-8">Why Choose Befiler for Income Tax Returns</h2>
      ...
      <div className="bg-[#af0e0e]/5 rounded-lg p-8 text-center">
        ...
        <p className="text-muted-foreground mb-6">
          Join thousands of satisfied customers who trust Befiler with their complete tax filing needs.
        </p>
