          ...
          >
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button variant="outline" className="text-black border-white hover:text-[#af0e0e] hover:border-[#af0e0e] hover:bg-white">
          ...
          <Tabs defaultValue="business" className="w-full">
            ...
            <TabsContent value="tax" className="mt-4">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                    <FileCheck className="mr-2 h-6 w-6 text-red-700" />
                    Tax Certificates
                  </CardTitle>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              {
                icon: <FileCheck className="h-10 w-10 text-red-700" />,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="mb-4 p-3 bg-red-50 rounded-full">{benefit.icon}</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button className="bg-[#af0e0e] hover:bg-[#8a0b0b]">Request a Certificate</Button>
              <Button variant="outline" className="text-black border-white hover:text-[#af0e0e] hover:border-[#af0e0e] hover:bg-white">
                Contact Our Team
              </Button>
            </div>
