          ...
          >
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button
                  variant="outline"
                  className="text-black border-white hover:text-[#af0e0e] hover:border-[#af0e0e] hover:bg-white"
                >
                  Learn More
                </Button>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button className="bg-[#af0e0e] hover:bg-[#8a0b0b]">Schedule a Consultation</Button>
              <Button
                variant="outline"
                className="text-black border-white hover:text-[#af0e0e] hover:border-[#af0e0e] hover:bg-white"
              >
