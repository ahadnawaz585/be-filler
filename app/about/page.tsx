    ...
    <main className="container mx-auto px-4 py-16 mt-16">
        ...
        {stats.map((stat, index) => (
          <Card key={index}>
            <CardContent className="p-6 text-center">
              <div className="w-12 h-12 bg-[#af0e0e]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <stat.icon className="w-6 h-6 text-[#af0e0e]" />
              </div>
      ...
      <div className="bg-[#af0e0e]/5 rounded-lg p-8 text-center">
        ...
        <p className="text-muted-foreground mb-6">
          Join thousands of satisfied customers who trust Befiler with their tax filing needs.
        </p>
