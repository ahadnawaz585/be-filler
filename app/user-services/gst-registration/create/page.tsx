...
import { GstRegistrationService, CreateGstRegistrationDto } from "@/services/gst-registration.service"; // Adjust path as needed
...
const CreateGstRegistration = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const newRegistrationData: CreateGstRegistrationDto = {
                businessName,
                businessType,
                startDate,
                businessNature,
                description: description || undefined, // Handle optional field
                consumerNumber,
                // gstin: "", // GSTIN will be generated by the backend
                state: "Unknown", // Default state, adjust as needed
            };
            const newRegistration = await gstRegistrationService.create(newRegistrationData);
            toast({
                title: "Success",
                description: `GST registration for ${businessName} created successfully.`,
                className: "bg-green-100 text-green-800 border-green-500",
            });
            router.push(`/user-services/gst-registration/${newRegistration.id}/documents`);
        } catch (error) {
